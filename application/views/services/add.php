    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
		    ...
		    <div class = "row" style = "padding-left:30px;padding-right:30px">
		    	<form role="form" method = "POST" action = "<?php echo base_url();?>services/add" id = "service-form">
		    		<div class = "row">
			    		<h2>Add Service</h2>
			    		<hr/>	
					   ...
					   <div class="form-group">
					      ...
					      <textarea class = "form-control" name = "service_details" id = "service_details" style = "height:150px;resize:none">
					      </textarea>
					   </div>

						<div class="form-group">
						    <label>Petsize</label>
							  	<select class="form-control" name = "service_size" >
					   ...
					   <div class="form-group">
					      ...
					      <input type="text" name = "service_amount" id = "service_amount" class="form-control" id="service_amount" placeholder="Service Amount">
					   </div>
    ...
    <script>
    	$('#servicesHeader').addClass('active');
			...
			$('#confirm-btn').on('click',function(e){
				...
				if($('#service_name').val() == "" || $('#service_amount').val() == ""){
