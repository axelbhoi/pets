...
<body>
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo $transactions_count;?></div>
                    ...
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo $total_alerts;?></div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> Latest Transactions
                        </div>
                        <!-- /.panel-heading -->
                                                ...
                                                <?php if($transactions):?>
                                                    <?php foreach($transactions as $transaction):?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $transaction->employee_firstname.'&nbsp'.$transaction->employee_lastname;?></td>
    ...
    <script type = "text/javascript">
        ...
        $(document).ready(function(){
            var services = "<?php echo $services_count?>";

            var items = "<?php echo $items_count?>";
            console.log(services);
            Morris.Donut({
              element: 'donut-example',
              data: [
                {label: "Services", value: parseInt(services)},
                {label: "In-Store Sales", value: parseInt(items)}
              ]
            });
        });
    </script>
