            ...
            <div class = "row">
                <h1>Monthly Sales Report</h1>
                    ...
                    <div class = "col-md-12" style = "padding:0px">
                        <form method = "POST" action = "<?php echo base_url();?>reports/sales_report" id = "service-form">
                            <div class = "col-md-6">
            						...
            						<tbody>
                                        <?php foreach($reports as $report):?>
                                            <tr>
                                                ...
                                                <td><?php echo $report->inventory_name;?></td>
                                                <td><?php echo $report->inventory_quantity;?></td>
                                                <td><?php echo $report->inventory_price;?></td>
