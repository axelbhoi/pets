...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
	                <div class="row" style = "margin-left:0px;margin-right:0px">
	                    <div class="col-md-12" style = "padding:0px">
	                        <h1 class="page-header">
	                            Licenses Expense&nbsp;<a href="<?php echo base_url();?>expenses/create_license_expenses" class="btn btn-primary" id="add-client"><i class="fa fa-plus"></i> Create License Expense</a>
	                        </h1>
                    ...
                    <div class = "col-md-12" style = "padding:0px">
                        <form method = "POST" action = "<?php echo base_url();?>expenses/license_fees" id = "office_form">
                            <div class = "col-md-6">
                                        ...
                                        <?php if($licenses):?>
                                            <?php foreach($licenses as $license):?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $license->license_amount;?></td>
                                                    <td>
                                                        <a href = "#" class = "delete-expenses" id = "<?php echo $license->id;?>" month = "<?php echo $license->month;?>" year = "<?php echo $license->year;?>"><i class = "fa fa-trash"></i></a>                                                    
                                                    </td>
                                                </tr>
                                            <?php endforeach;?>
                                        <?php endif;?>
                              ...
                              <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                  <div class="modal-header modal-header-alert">
                                    <h4 class="modal-title">Delete Licenses</h4>
                                  </div>
                                  <div class="modal-body">
                                    ...
                                    <form id = "delete-expenses-form" role = "form" action = "<?php echo base_url();?>expenses/delete_license_fees" method = "POST">
