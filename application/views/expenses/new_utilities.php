            ...
            <div class="row">
                ...
                <ol class="breadcrumb bread-primary " style = "background-color: #ffffff !important" >
                  <button href="#" class="btn btn-primary"><i class="fa fa-home"></i> Home</button>
                    <li><a href="<?php echo base_url();?>expenses/utilities">Utilities Expense</a></li>
                    <li class="active">New Utilities Expense</li>
                </ol>
            </div>

            <div class = "row" style = "padding-left:30px;padding-right:30px">

                <form role="form" id = "license_form" method = "POST" action = "<?php echo base_url();?>expenses/create_utilities_expenses">
                <?php if($confirmation == "submitted"):?>
                    <div class="alert alert-success alert-dismissible fade in" role = "alert" > 
                        <strong>Yes!</strong> You have successfully Added a Utilities Expense.
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>                    
                    </div>
                <?php endif;?>
                    <h2>New Utilities Expense</h2>
                   ...
                   <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="utility_amount" name = "utility_amount" placeholder="Utility Amount">
                   </div>

                    <button class = "btn btn-primary" style = "margin-bottom:5px;width:100%;" id = "confirm-btn">Confirm</button>
                    <a href = "<?php echo base_url();?>expenses/utilities" class = "btn btn-danger" style = "margin-bottom:5px;width:100%;" id = "cancel-btn">Cancel</a>
    ...
    <script type = "text/javascript">
        $(document).ready(function(){
            ...
            $('#confirm-btn').on('click',function(e){
                ...
                if( $('#utility_name').val() != "" && $('#utility_amount').val() != "" && $('#curr_date').val() != "" ){
                    $('#license_form').submit();
                }
                else{
            ...
            $('#utility_amount').keypress(function(event) {
