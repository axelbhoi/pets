            ...
            <div class="row">
                ...
                <ol class="breadcrumb bread-primary " style = "background-color: #ffffff !important" >
                  <button href="#" class="btn btn-primary"><i class="fa fa-home"></i> Home</button>
                    <li><a href="<?php echo base_url();?>expenses/license_fees">Licenses Expense</a></li>
                    <li class="active">New License Expense</li>
                </ol>
            </div>

            <div class = "row" style = "padding-left:30px;padding-right:30px">

                <form role="form" id = "license_form" method = "POST" action = "<?php echo base_url();?>expenses/create_license_expenses">
                <?php if($confirmation == "submitted"):?>
                    <div class="alert alert-success alert-dismissible fade in" role = "alert" > 
                        <strong>Yes!</strong> You have successfully Added a License Expense.
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>                    
                    </div>
                <?php endif;?>
                    <h2>New License Expense</h2>
                   ...
                   <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="license_amount" name = "license_amount" placeholder="License Amount">
                   </div>
    ...
    <script type = "text/javascript">
        $(document).ready(function(){
            ...
            $('#confirm-btn').on('click',function(e){
                ...
                if( $('#license_name').val() != "" && $('#license_amount').val() != "" && $('#curr_date').val() != "" ){
                    $('#license_form').submit();
                }
                else{
            ...
            $('#license_amount').keypress(function(event) {
